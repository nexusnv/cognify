...
| P1-27 | Quotation Manual Entry | Support structured quotation entry when a vendor responds outside the portal or submits incomplete documents. Manual entry keeps the workflow usable before full OCR automation exists. | Planned | 2026-05-20-quotation-manual-entry-design.md | 2026-05-20-quotation-manual-entry.md |  | Planned as Epic 6 slice 3 after quotation upload. |
