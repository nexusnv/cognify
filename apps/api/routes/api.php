...
use Domains\Fulfillment\Http\Controllers\FulfillmentStatusController;
use Domains\Fulfillment\Http\Controllers\FulfillmentTrackingEventController;
use Domains\Fulfillment\Http\Controllers\ShipmentController;
...
use Domains\Receiving\Http\Controllers\GoodsReceiptController;
...
Route::middleware('auth:sanctum')->group(function (): void {
    ...
    Route::middleware(ResolveCurrentTenant::class)->group(function (): void {
        ...
        Route::middleware(RequireTenantHeader::class)->group(function (): void {
            ...
            Route::get('/purchase-orders/{purchaseOrder}/goods-receipts', [GoodsReceiptController::class, 'index']);
            Route::post('/purchase-orders/{purchaseOrder}/goods-receipts', [GoodsReceiptController::class, 'store']);
            ...
            Route::get('/purchase-orders/{purchaseOrder}/fulfillment', [FulfillmentStatusController::class, 'show']);
            Route::get('/purchase-orders/{purchaseOrder}/shipments', [ShipmentController::class, 'index']);
            Route::post('/purchase-orders/{purchaseOrder}/shipments', [ShipmentController::class, 'store']);
            Route::get('/goods-receipts/{goodsReceipt}', [GoodsReceiptController::class, 'show']);
            Route::post('/goods-receipts/{goodsReceipt}/confirm-requester', [GoodsReceiptController::class, 'confirmRequester']);
            Route::post('/goods-receipts/{goodsReceipt}/confirm-buyer', [GoodsReceiptController::class, 'confirmBuyer']);
            ...
            Route::get('/ap-payment-handoffs', [ApPaymentHandoffController::class, 'index']);
            Route::post('/ap-payment-handoffs', [ApPaymentHandoffController::class, 'store']);
            Route::get('/ap-payment-handoffs/{handoff}', [ApPaymentHandoffController::class, 'show']);
            Route::patch('/ap-payment-handoffs/{handoff}', [ApPaymentHandoffController::class, 'update']);
            Route::post('/ap-payment-handoffs/{handoff}/refresh', [ApPaymentHandoffController::class, 'refresh']);
            Route::post('/ap-payment-handoffs/{handoff}/ready', [ApPaymentHandoffController::class, 'markReady']);
            Route::post('/ap-payment-handoffs/{handoff}/cancel', [ApPaymentHandoffController::class, 'destroy']);
            Route::get('/ap-payment-handoffs/{handoff}/export.json', [ApPaymentHandoffController::class, 'exportJson']);
            ...
            Route::get('/shipments/{shipment}/tracking-events', [FulfillmentTrackingEventController::class, 'index']);
            Route::post('/shipments/{shipment}/tracking-events', [FulfillmentTrackingEventController::class, 'store']);
            Route::patch('/shipments/{shipment}/lines/{line}/backorder', [ShipmentController::class, 'updateBackorder']);
        });
