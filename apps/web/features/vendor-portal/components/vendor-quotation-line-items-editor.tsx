...
import type { QuotationManualEntryFormValues } from "../../sourcing/schemas/quotation-manual-entry-schema";

export function VendorQuotationLineItemsEditor({
  lineItems,
  onChange,
  disabled,
}: {
    ...
    <div className="space-y-3">
      ...
      <div className="overflow-x-auto rounded-md border">
        <Table className="min-w-[66rem]">
          <TableHeader><TableRow><TableHead>Description</TableHead><TableHead>Quantity</TableHead><TableHead>Unit</TableHead><TableHead>Unit price</TableHead><TableHead>Total amount</TableHead><TableHead>Compliance</TableHead><TableHead>Notes</TableHead><TableHead>Action</TableHead></TableRow></TableHeader>
          <TableBody>
            {lineItems.length === 0 ? (
              <TableRow>
            ...
            {lineItems.map((lineItem, index) => (
              <TableRow key={buildRowKey(lineItem, index)} className="align-top">
                <TableCell className="px-3 py-3"><Input
