...
export function RfqDraftWorkspace({ rfqId }: { rfqId: string }) {
  ...
  if (rfqQuery.isLoading) {
    return <div aria-label="Loading RFQ workspace" className="p-4 text-sm text-muted-foreground">Loading RFQ workspace</div>;
  }
    ...
    <RecordWorkspaceLayout
      ...
      sidebar={
        <>
          <Card>
            <CardHeader>
              <CardTitle className="text-base">Source requisition</CardTitle>
            </CardHeader>
            <CardContent>
              {requisition ? (
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-base">Source intake</CardTitle>
            </CardHeader>
            <CardContent>
              {intakeReview ? (
                <dl className="grid gap-3 text-sm">
